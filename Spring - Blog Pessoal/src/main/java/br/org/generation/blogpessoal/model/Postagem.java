...
public class Postagem {
	 ...
	 * 
	 * O parâmetro strategy indica como o Banco de dadoas irá gerar a chave primária. 
	 * 
	 ...
	 * a propriedade autoincrement do SQL. 
	 * 
	 ...
	 * caracteres de um atributo. Não é obrigatório definir os 2 parâmetros, 
	 * você pode definir apenas um deles.
	 * 
	 *                            ***IMPORTANTE*** 
	 * 
	 * Para utilizar estas anotaçõess, não se esqueça de inserir a dependência 
